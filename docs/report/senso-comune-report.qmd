...
page and on the title page. All from `brand/mark-lockup.png`, by one crop.
...
compressed to a narrow band about 0.5, tiled at 240 px. Measured back out of
Chrome on the built page, the field reads at **σ 5.1**, against the artwork's
4.87.
...
takes that line too — the **field**, the **bands** between sections and the
**mat** around every painting, and nothing that is read.
...
![The How to Buy page, which puts the duty figure in front of the buyer before they commit rather than after.](fig/cap-buy.jpg){#fig-buy width=100%}
