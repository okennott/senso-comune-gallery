...
Research and scope only. Nothing described here is built, except the
verification fix in @sec-next-harness, which the scope depends on. Each
recommendation is marked, and every decision that belongs to Priscilla is
listed in @sec-next-decisions before any work begins.
